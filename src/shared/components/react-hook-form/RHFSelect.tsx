...
import type { MultiValue, SelectOption, SelectProps, SelectValue, SingleValue } from "../select";
import { getOptionsValue, onSelectChange, Select } from "../select";

export interface RHFSelectProps<TFieldValues extends FieldValues = FieldValues> extends Omit<
  SelectProps,
  "name" | "error" | "value" | "defaultValue" | "onChange"
> {
  /**
